...
if (!class_exists('Easy_Event_Registration')) {
	...
	final class Easy_Event_Registration {
		...
		private function includes() {
			...
			require_once EER_PLUGIN_PATH . '/inc/class/eer-pdf-ticket.class.php';
			...
			require_once EER_PLUGIN_PATH . '/inc/template/email/eer-ticket-email.template.php';
