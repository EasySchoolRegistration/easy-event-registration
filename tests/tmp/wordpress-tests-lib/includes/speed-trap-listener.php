...
class SpeedTrapListener implements PHPUnit_Framework_TestListener
{
    ...
    {
        if (!$test instanceof PHPUnit_Framework_TestCase2) return;
     ...
     *
     * @param PHPUnit_Framework_TestCase2 $test
     * @param int                         $time Test execution time in milliseconds
     */
    protected function addSlowTest(PHPUnit_Framework_TestCase2 $test, $time)
    {
     ...
     * @return string
     */
    protected function makeLabel(PHPUnit_Framework_TestCase2 $test)
    {
     ...
     * @return int
     */
    protected function getSlowThreshold(PHPUnit_Framework_TestCase2 $test)
    {
