...
class EER_Enqueue_Scripts {
	...
	public static function eer_scripts_fontawesome_callback() {
		wp_enqueue_style('eer_admin_font_awesome_style', EER_PLUGIN_URL . 'libs/font-awesome/css/font-awesome.css', [], EER_VERSION);
	}


	public static function eer_scripts_botstrap_callback() {
		wp_enqueue_style('eer_admin_font_awesome_style', EER_PLUGIN_URL . 'libs/font-awesome/css/font-awesome.css', [], EER_VERSION);
	}
...
add_action('eer_scripts_fontawesome', ['EER_Enqueue_Scripts', 'eer_scripts_fontawesome_callback']);