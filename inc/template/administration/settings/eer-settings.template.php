...
class EER_Template_Settings
{
	...
	public static function print_content()
	{
		...
		<div class="wrap <?php echo 'wrap-' . $active_tab; ?>">
			<h2><?php _e('Easy Event Registration Settings', 'easy-event-registration'); ?></h2>
			...
			<div id="tab_container">
				<form method="post" action="options.php">
					<table class="form-table">
						...
						settings_fields('eer_settings');

						do_action('eer_settings_tab_top_' . $active_tab . '_' . $section);

						do_settings_sections('eer_settings_' . $active_tab . '_' . $section);

						do_action('eer_settings_tab_bottom_' . $active_tab . '_' . $section);
